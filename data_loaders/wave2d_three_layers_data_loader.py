...
class Wave2DThreeLayersGroundTruthLoader:
    def __init__(self, model_name="NeuSA"):
        self.model_name = model_name
        self.data_dir_path = os.path.join(os.path.dirname(os.path.dirname(os.path.abspath(__file__))), "data", "wave2d_three_layers")
    ...
    def get_ground_truth_grid_as_tensors(self):
        ...
        if self.model_name == "PINNsFormer":
            grid_as_tensors = Grid3DPINNsFormerToTensors(self.x,self.y, self.t) 
